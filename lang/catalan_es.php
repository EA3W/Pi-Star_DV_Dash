...
$lang = array (
  ...
  "update"                      =>  "Actualitzar",
  "backup_restore"              =>  "Fer/Restaurar còpia de seguretat",
  ...
  "wifi_config"                 =>  "Configuració del WIFI",
  ...
  "dstar_irc_time"              =>  "Interval de Balisa",
  // Config Page - YSF Configuration
  "ysf_startup_host"            =>  "Arrencant Host YSF",
  // Config Page - P25 Configuration
  "p25_startup_host"            =>  "Arrencant Host P25",
  "p25_nac"                     =>  "P25 NAC",
  // Config Page - NXDN Configuration
  "nxdn_startup_host"            =>  "Arrencant Host NXDN" ,
  "nxdn_ran"                     =>  "NXDN RAN",
  ...
  "ber"                         =>  "BER",
  // POCSAG Specific
  "pocsag_list"                 =>  "Activitat de la passarel·la DAPNET",
